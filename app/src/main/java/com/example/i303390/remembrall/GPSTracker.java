...
/**
 * Created by I320047 on 12/13/2016.
 */
...
public class GPSTracker extends Service implements LocationListener {
    ...
    private boolean isLocationEqual(LatLng loc1, Location loc2) {
        int lat1 = (int)loc1.latitude*100;
        int lat2 = (int)loc2.getLatitude()*100;
        int lon1 = (int)loc1.longitude*100;
        int lon2 = (int)loc2.getLongitude()*100;
